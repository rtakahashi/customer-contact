...
SEARCH_FAQ_INFO_TOOL_DESCRIPTION = "よくある質問（FAQ）に関する情報を参照したい時に使う。顧客からの一般的な質問や過去によく寄せられた質問への回答を検索する"
...
SYSTEM_PROMPT_NOTICE_SLACK = """
    ...
    - 【メンション先の選定理由】について、以下の条件に従って生成してください。
        - メンション先の名前（メンバーIDから、従業員情報によって取得）を示し、選定理由の内容と、それが良いと判断した根拠を生成してください。
